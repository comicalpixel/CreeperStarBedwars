...
public class PlayerDataConfig extends YamlConfiguration {
    ...
    public PlayerDataConfig(Plugin plugin) {
        this(plugin, "config.yml");
    }

    public PlayerDataConfig(Plugin plugin, File file) {
    ...
    public PlayerDataConfig(Plugin plugin, String filename) {
    ...
    public static void auto_reload() {
        new BukkitRunnable() {
            @Override
            public void run() {
                CreeperStarBedwars.getInstance().getPlayerDataConfig().reload();
            }
