...
public class ItemShop_NPC implements Listener {
    ...
    public static void spawn(Location loc) {
        ...
        npc.setHealth(20);
        npc.setCustomName(ConfigData.language_shopgui_item_NPCname + "§e§k§l§a");
//        npc.getBukkitEntity().setMetadata("ItemShop_NPC", new FixedMetadataValue(CreeperStarBedwars.getPlugin(), null));
    ...
    public void onPlayerClickVillager(PlayerInteractEntityEvent e) {
        ...
        // 这里就不加判断是否是村民啦，可以方便开发者实现自定义，只要实体的CustomName最后包含"§e§k§l§a"就能打开啦
