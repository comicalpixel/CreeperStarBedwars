...
public class TeamGenerator_RED {
    ...
    private static Location resourceLocation = GameData_cfg.team_red_generator.clone().add(0, 1, 0); //GameData_cfg.team_red_generator.clone().add(0.5, 0.5, 0.5);
